...
Array.prototype.concatMap = require('../Implementations/concatMap');
...
function useConcatMap() {
    ...
    return movieLists.concatMap((genre) => {
        return genre.videos.concatMap((video) => {
